...
export default function DiscussGroup() {
    ...
    //             <Header />
    //             <Box m={'3vw'}>
    //             <Button style={{color:'black'}} component={Link} to='/home'><ArrowBackIosNew sx={{fontSize:'1.5vw'}} /></Button><span style={{fontWeight:'bold', fontSize:'2vw'}}>群組名稱在這裡</span>
    //             {/* 群組資訊 */}
    //             <Box style={{marginTop:'30px', backgroundColor:'white', padding:'2vw'}}>
